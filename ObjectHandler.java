...
public class ObjectHandler implements RequestHandler<S3Event, String> {
  ...
  public String handleRequest(S3Event s3event, Context context) {
    try {
      ...
      String dstBucket = "hapueweibucket-trans";
...
//            builder.append(label.getName() + label.getConfidence().toString());
//            builder.append("\n");
...
//                    request_N = new TranslateTextRequest()
//                            .withText(label.getConfidence().toString())
//                            .withSourceLanguageCode("en")
//                            .withTargetLanguageCode("zh");
//                    result_N  = translate.translateText(request_N);
//                    builder.append(result_N.getTranslatedText());
                    builder.append("\n");
                }
            }
